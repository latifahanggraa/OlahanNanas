    ...
    <div class="col-md-12">
        <div class="tile">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="<?php echo $root_path ?>/dashboard/category/add.php" class="btn btn-primary">
                    Tambah Kategori
                </a>
            </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo $root_path ?>/dashboard/category/update.php?edit=<?php echo $data['id']; ?>" class="btn btn-info">Edit</a>
                            </td>
                            <td>
