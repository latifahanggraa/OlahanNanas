...
?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6" style="background-color: white; max-height: 380px; padding: 35px; border-radius: 3px; box-shadow: 0px 2px 2px rgba(0, 0, 0, 0.5);">
          <h3 class="tile-title" style="margin-top: -10px; margin-bottom: 30px;">Total Income</h3>
